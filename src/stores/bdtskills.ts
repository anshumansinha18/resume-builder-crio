...
export const useLanguages = create<ISkillState>(
  persist(
    (set, get) => ({
      title: 'Languages',
      hasLevel: false,
      values: resumeData.bdtskills.languages,
      isEnabled: true,
...
export const useFrameworks = create<ISkillState>(
  persist(
    (set, get) => ({
      title: 'Frameworks',
      hasLevel: true,
      values: resumeData.bdtskills.frameworks,
      isEnabled: true,
...
export const useTechnologies = create<ISkillState>(
  persist(
    (set, get) => ({
      title: 'Technologies',
      hasLevel: false,
      values: resumeData.bdtskills.technologies,
      isEnabled: true,
...
export const useLibraries = create<ISkillState>(
  persist(
    (set, get) => ({
      title: 'Libraries',
      hasLevel: false,
      values: resumeData.bdtskills.libraries,
      isEnabled: true,
...
export const useDatabases = create<ISkillState>(
  persist(
    (set, get) => ({
      title: 'Databases',
      hasLevel: false,
      values: resumeData.bdtskills.databases,
      isEnabled: true,
...
export const usePractices = create<ISkillState>(
  persist(
    (set, get) => ({
      title: 'Practices',
      hasLevel: false,
      values: resumeData.bdtskills.practices,
      isEnabled: true,
...
export const useTools = create<ISkillState>(
  persist(
    (set, get) => ({
      title: 'Tools',
      hasLevel: false,
      values: resumeData.bdtskills.tools,
      isEnabled: true,
